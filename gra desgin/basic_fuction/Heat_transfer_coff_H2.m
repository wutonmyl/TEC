function [alpha_i,n,choice,Nu_in,Re_g] = Heat_transfer_coff_H2(Ti,Tg,i,par)
%HEAT 计算流体侧对流传热系数
%   此处显示详细说明
[Cp_g,density_g,H_g,mu_g,lamda_g,Pr_g]=refpropm('CDHVL^','T',Tg,'P',par.P,'hydrogen');
[density_i,H_i]=refpropm('DH','T',Ti,'P',par.P,'hydrogen');
