function [T_chip,Tc,Th,To,Ti,Tg,hg,flag,n,choice] = function_solver(par,T_g_in,i,mode,hight,slope)
%FUNCTION_SOLVER 此处显示有关此函数的摘要
%   此处显示详细说明
rng default
x = optimvar('x',6,'LowerBound',[50,50,50,50,100,100],'UpperBound',[800,800,800,800,930,600]);
%第一个式子关于pchip还需要修改
eq1 = heat_change(i,mode,hight,slope)==par.k_ct*par.a_te*(x(1)-x(2));
