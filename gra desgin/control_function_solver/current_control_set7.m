function [data,wrong_num_record,i_final] = current_control_set7(par,ub,lb,grad_bond,search_num,mode,hight,slope)
...
T_chip_target_ub_record = zeros(search_num);
T_chip_target_lb_record = zeros(search_num);
