function [Q_tec_record,COP_record,i_record,Dz_record,Tchip_record,Tc_record,Th_record,To_record,Ti_record,Tg_record,...
        ...
        wrong_num_record,mean_T_chip,median_T_chip,geomean_T_chip,harmmean_T_chip,range_T_chip,var_T_chip,std_T_chip,i_final] = current_control_set5(par,ub,lb,grad_bond,search_num)
%%  本函数是用于整合原main5函数的所有求解外设置部分，将求解流程整流为一整个输入输出函数，目的是用于新main5整体优化求取最小梯度限制值
%   此处显示详细说明
