function [I,Tc,Th,To,Ti,Tg,h,flag,n,choice,T_chip] = current_control_function_solver_fixed7(par,T_g_in,i,j,Tchip_target_recmd_ub,Tchip_target_recmd_lb,I_record,mode,h,slope)
%   为main5适配的独立控制求解器
...
% else
%     %把连续性要求也放到里面去
%     target = a*(x(7)-Tchip_target_recmd)^2+b*(I_record(i-1,j)-x(1))^2;
% end
...
prob.Constraints.target_ub_limit = target_ub_limit;
prob.Constraints.target_lb_limit = target_lb_limit;
